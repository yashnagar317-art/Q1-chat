...
function clearError() {
    ...
    if (dom.authStatus) {
        ...
        dom.authStatus.classList.remove(
            "error"
        );
    }
}
...
function renderFriendButton() {
    ...
    dom.addFriend.disabled =
        false;


    dom.addFriend.dataset.userId =
        userId;


    if (isFriend(userId)) {

        dom.addFriend.textContent =
            "✓ Friends";

        dom.addFriend.classList.add(
            "is-friend"
        );
    ...
    if (
        ...
        dom.addFriend.classList.remove(
            "is-friend"
        );
    ...
    if (
        ...
        body = `
            <div class="message-media">
                ...
                <img
                    class="chat-image"
                    data-media-path="${escapeAttribute(
                        message.media_path || ""
                    )}"
                    alt="Shared image"
                    loading="lazy"
